...
const ExpiredFoodsItem = (props) => {
    ...
    const src = props.goodsImages.length > 0 ? Server.getThumbnailURL()+ props.goodsImages[0].imageUrl : ''
        ...
        <Fragment>
            ...
            <div className='bg-white p-2 pl-3 pr-3'>
                ...
                <div className='d-flex align-items-center mb-2'>
                    {/*<Checkbox id={checkBoxId} className={'p-0'} color={'default'} checked={props.checked} />*/}
                    <span>{props.goodsNm}</span>
                ...
                <div className='d-flex align-items-top mb-2'>
                    ...
                    <div>
                        ...
                        <img className={Style.goodsImage} src={src} onClick={onClick} alt={'사진'}/>
                    ...
                    <div className='flex-grow-1 ml-2'>
                        <div className='d-flex mb-1 text-dark f6'>
                            ...
                            <div className='text-right flex-grow-1'>{ComUtil.addCommas(props.currentPrice)} 원</div>
                        </div>
...
export default ExpiredFoodsItem