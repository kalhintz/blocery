...
import { updateReceiverInfo } from '~/lib/b2bShopApi'
            ...
            <Fragment>
                <Container>
                    ...
                    <Row>
                        <Col xs={12}>
                            <FormGroup>
                                <Button block color={'primary'} onClick={this.saveAddress} disabled={order.receiverName && order.receiverPhone && order.receiverAddr && order.receiverAddrDetail ? false : true}>확인</Button>
                            </FormGroup>
                        </Col>
                    </Row>
                </Container>
