...
const DealSaleTransition = (props) => {
    ...
    async function search() {
        ...
        // 주문/매출 추이 1월~12월
        const { data } = await getTransitionWithDealSaleBySellerNo();
    ...
    return (
        <Fragment>
            ...
            <h6 className='text-dark'>주문/매출 추이</h6>
            <div className='d-flex justify-content-center align-items-center border-light bg-warning'>
                <HighchartsReact
...
export default DealSaleTransition