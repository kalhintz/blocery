...
import { getOperStatWaesangDealCntBySellerNo } from '~/lib/b2bSellerApi'
...
const WaesangDealCnt = (props) => {
    ...
    async function search() {
        ...
        // 외상거래건수 (오늘, 어제, 주간, 월간)
        const { status, data } = await getOperStatWaesangDealCntBySellerNo();
        ...
        <Fragment>
            ...
            <div className='mr-1'>
                <div className='p-2 bg-secondary text-white'>
                    <div className='text-center f6 font-weight-light'>외상거래건수</div>
