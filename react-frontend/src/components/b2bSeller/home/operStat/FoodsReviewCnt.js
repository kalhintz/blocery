...
import { getOperStatFoodsReviewCntBySellerNo } from '~/lib/b2bSellerApi'
...
const FoodsReviewCnt = (props) => {
    ...
    async function search() {
        ...
        // 상품후기건수 (오늘, 어제, 주간, 월간)
        const { status, data } = await getOperStatFoodsReviewCntBySellerNo()
        ...
        <Fragment>
            ...
            <div className='mr-1'>
                <div className='p-2 bg-secondary text-white'>
                    <div className='text-center f6 font-weight-light'>상품후기</div>
