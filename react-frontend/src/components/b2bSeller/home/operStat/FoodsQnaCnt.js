...
import { getOperStatFoodsQnaCntBySellerNo } from '~/lib/b2bSellerApi'
...
const FoodsQnaCnt = (props) => {
    ...
    async function search() {
        ...
        // 상품문의건수 (오늘, 어제, 주간, 월간)
        const { status, data } = await getOperStatFoodsQnaCntBySellerNo();
        ...
        <Fragment>
            ...
            <div className='mr-1'>
                <div className='p-2 bg-secondary text-white'>
                    <div className='text-center f6 font-weight-light'>상품문의</div>
