...
import { getDealStatDealConfirmOkCntBySellerNo } from '~/lib/b2bSellerApi'
import { BlocerySpinner, HeaderTitle } from '~/components/common'
import { faSignature } from "@fortawesome/free-solid-svg-icons";
import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";


const DealConfirmOk = (props) => {
    ...
    async function search() {
        ...
        // 주문현황 결제완료 최근개월기준
        const { status, data } = await getDealStatDealConfirmOkCntBySellerNo();
