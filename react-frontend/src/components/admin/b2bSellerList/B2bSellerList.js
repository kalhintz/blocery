...
import { getAllSellers } from '../../../lib/adminApi'
import { scOntGetBalanceOfBlct } from '../../../lib/smartcontractApi'
import { Server } from '../../../components/Properties';
import axios from 'axios';
import { getLoginAdminUser } from '../../../lib/b2bLoginApi'
...
export default class B2bSellerList extends Component{
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            data: [],
            columnDefs: [
                {headerName: "회원번호", field: "sellerNo", sort:"asc"},
    ...
    search = async () => {
        ...
        const { status, data } = await getAllSellers()
        if(status !== 200){
            alert('응답이 실패 하였습니다')
            return
        }
