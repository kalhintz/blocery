...
const EventPopup = () => {
    ...
    return (
        <div style={{fontSize:'0.85rem'}}>
            <b className='text-info'>프리미엄 채소 에어드랍 이벤트가 많은 분들의 관심속에 성황리에 조기 마감 되었습니다.</b><br/>
            참여해 주신 모든 분들께 감사의 말씀 드리며<br/>상품은 <b className='text-info'>6/17, 6/20, 6/25일</b> 순차 발송 될 예정입니다.<br/>
            <small>(추첨 상품은 6월말 ~ 7월초 사이 발송 예정)</small><br/>
            배송관련 문의는 cs@blocery.io 로 문의 주세요.<br/><br/>
