...
import { FaClock, FaBolt, FaCoins, FaShoppingCart, FaBoxOpen } from 'react-icons/fa'
                    ...
                    <Row>
                        <Col xs={12} sm={12} md={6} className='p-0'>
                            <Col sm={12} className='mb-3'>
                                <Card body>
                                    <CardTitle className='f2'><span className='d-flex align-items-center'><FaClock className='mr-2'/>예약상품</span></CardTitle>
                                    <CardText>
                            ...
                            <Col sm={12} className={'mb-3'}>
                                <Card body>
                                    <CardTitle className='f2'><span className='d-flex align-items-center'><FaBolt className='mr-2'/>즉시상품</span></CardTitle>
                                    <CardText>
                        ...
                        <Col sm={12} md={6} className='p-0'>
                            <Col sm={12} className='mb-3'>
                                <Card body>
                                    <CardTitle className='f2'><span className='d-flex align-items-center'><FaCoins className='mr-2' />배송/지연 보상제도</span></CardTitle>
                                    <CardText>
                            ...
                            <Col sm={12} className={'mb-3'}>
                                <Card body>
                                    <CardTitle className='f2'><span className='d-flex align-items-center'><FaBoxOpen className='mr-2' />취소/교환/환불</span></CardTitle>
                                    <CardText>
