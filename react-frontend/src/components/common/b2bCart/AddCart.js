...
import { addCart } from '../../../lib/b2bCartApi'
...
import * as actions  from '../../../reducers/B2bCartReducer'
        ...
        <div className={classNames('p-3', Style.wrap)} >
            {
                isAdded ? (
                    <Fragment>
                        ...
                        <Button className='p-2 f2' color='primary' block onClick={movePage}>구매하러 가기 >>></Button>
                    </Fragment>
                ) : (
                    ...
                    <Fragment>
                        ...
                        {
                            qty <= remainedCnt ? <Button className='p-2 f2 rounded-0' color='primary' block onClick={onConfirmClick}>추가</Button> : <Alert className='mt-3' color='danger'>재고수량 부족(구입가능 수량 : {remainedCnt}개)</Alert>
                        }
                    </Fragment>
                )
            }
