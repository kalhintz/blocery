...
import { getOperStatRegularShopCntByProducerNo } from '~/lib/producerApi'
        ...
        <Fragment>
            ...
            <div className='mr-1'>
                <div className='p-2 bg-secondary text-white'>
                    <div className='text-center f6 font-weight-light'>단골회원</div>
