...
import Style from './GoodsQnaAnswer.module.scss';

export default class GoodsQnaAnswer extends Component{
    constructor(props){
        super(props);
        this.state = {
                    ...
                    <ListGroup>
                        <ListGroupItem>
                            <div>
                                ...
                                <span className='f5 text-secondary text-dark font-weight-bold'>{ goodsQna.goodsQnaNo }</span>
                            ...
                            <div>
                                ...
                                <span className='f5 text-secondary text-dark'>{ goodsQna.goodsNo }</span>
                    ...
                    <div className={Style.answerBox}>
                        ...
                        <div className="d-flex justify-content-between p-1">
                            <div className="d-flex w-100">
                                <Button color={'info'} block onClick={this.onClose}>{this.state.act === 'U' ? '취소':'닫기' }</Button>
                            </div>
                            {
                                this.state.act === 'U' ?
