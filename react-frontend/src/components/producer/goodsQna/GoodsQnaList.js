...
import Style from './GoodsQnaList.module.scss'
//ag-grid
import { AgGridReact } from 'ag-grid-react';
import 'ag-grid-community/dist/styles/ag-grid.css';
import 'ag-grid-community/dist/styles/ag-theme-balham.css';
import GoodsQnaAnswer from "./GoodsQnaAnswer";
    ...
    goodsQnaMobileRenderer = ({value, data:rowData}) => {
        ...
        return (
            <Cell height={this.rowHeight}>
                <div>
                    <span className='small'>문의번호 : {rowData.goodsQnaNo}</span><br/>
                    <span className='small'>상품명 : ({rowData.goodsNo}) {rowData.goodsName}</span><br/>
